...
module['exports'] = function (r, resource) {
  ...
  Object.keys(r.dependencies).forEach(function (dep) {
    ...
    //
    resourcePath = require.resolve('resources').replace('index.js', '') + './node_modules/';
    resourcePath += dep;
  ...
  var spawn = require('child_process').spawn,
      npm   = spawn(npmBinary, _command, { cwd: p });

  console.log('contacting to npm servers to install dependencies...');
