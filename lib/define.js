...
module['exports'] = function (name, options) {
  ...
  // defaults to only allowing specified schema properties to persist
  r.strictProperties = true;
  if (options.strictProperties === false) {
    // will allow any additional / optional values into the database
    r.strictProperties = false;
  }
  //
